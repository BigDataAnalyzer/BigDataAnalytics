...
def get_time_range(date_obj):
 	...
 	if date_obj.hour>=10.01 and date_obj.hour<=12: 
 		return "10-12"

 	if date_obj.hour>=12.01 and date_obj.hour<=17:
 		return "12-17"

 	if date_obj.hour>=17.01 and date_obj.hour<=20: 
 		return "17-20"

 	if date_obj.hour>=20.01 and date_obj.hour<=22:
 		return "20-22"

 	if date_obj.hour>=22.01 and date_obj.hour<=00: 
 		return "22-00"

 	if date_obj.hour>=00.01 and date_obj.hour<=7:
 		return "00-7"
...
for line in sys.stdin:
	...
	print result + "," + time_range + "," + dist_range + "\t" + total_amount + ","  +str(trip_seconds)
